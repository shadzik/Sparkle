Pod::Spec.new do |s|
  ...
  s.platform = :osx, '10.7'
  #s.source   = { :http => "https://github.com/shadzik/Sparkle/releases/download/#{s.version}/Sparkle-#{s.version}.tar.bz2" }
  s.source   = { :git => "https://github.com/shadzik/Sparkle.git", :branch => 'feature/appcast-url' }
